...
#Suppressing password promts for this user so hush node can operate
...
echo -e "\033[1;33m=======================================================\033[0m"
echo "INSTALLING HUSHNODE DEPENDENCIES"
echo -e "\033[1;33m=======================================================\033[0m"
...
if [ "x$PASSWORD" = "x" ]; then
    ...
    echo zelnodeprivkey=$hushnodeprivkey >> ~/.hush/$CONFIG_FILE
    ...
    echo "addnode=explorer.zel.cash" >> ~/.hush/$CONFIG_FILE
    echo "addnode=explorer.zel.zelcore.io" >> ~/.hush/$CONFIG_FILE
    echo "addnode=explorer2.zel.cash" >> ~/.hush/$CONFIG_FILE
    echo "addnode=explorer.zelcash.online" >> ~/.hush/$CONFIG_FILE
    echo "addnode=node-eu.zelcash.com" >> ~/.hush/$CONFIG_FILE
    echo "addnode=node-uk.zelcash.com" >> ~/.hush/$CONFIG_FILE
    echo "addnode=node-asia.zelcash.com" >> ~/.hush/$CONFIG_FILE
    echo "maxconnections=256" >> ~/.hush/$CONFIG_FILE
    #must add the correct node addresses!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
